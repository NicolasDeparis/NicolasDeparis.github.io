...
(function($) {
    ...
    $.ScalebarSizeAndTextRenderer = {
        ...
        METRIC_LENGTH: function(ppm, minSize) {
            return getScalebarSizeAndTextForMetric(ppm, minSize, "pc");
        },
        /**
  ...
  /**
   * Cosmology units. Choosing the best unit from parsec, kiloparsec, and Megaparsec
   */
  COSMOLOGY: function(ppa, minSize) {
    var maxSize = minSize * 2;
          if (maxSize < ppa * 1000) {
              return getScalebarSizeAndText(ppa, minSize, "\pc", false, '');
          }
          var ppminutes = ppa * 1000;
          if (maxSize < ppminutes * 1000) {
              return getScalebarSizeAndText(ppminutes, minSize, "\kpc", false, '');
          }
          var ppd = ppminutes * 1000;
          return getScalebarSizeAndText(ppd, minSize, "Mpc", false, '');
    },
        /**
    ...
    function getWithUnit(value, unitSuffix) {
        ...
        if (value >= 1000) {
            return value / 1000 + " ck" + unitSuffix;
        }
        if (value >= 1000000) {
            return value / 1000000+ "  cM" + unitSuffix;
        }
